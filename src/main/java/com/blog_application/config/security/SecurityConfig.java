...
@SecurityScheme(name = "JWT Bearer Authentication", type = SecuritySchemeType.HTTP,  bearerFormat = "JWT"
        , scheme = "bearer", description = "Provide the JWT token in the 'Authorization' header in the format: Bearer <token>")
